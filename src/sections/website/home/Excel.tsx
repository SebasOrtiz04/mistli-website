...
const ReportGenerationSection: React.FC<ReportGenerationSectionProps> = ({
  ...
  return (
    <section
    id='documentos'
      className={`w-full max-w-6xl mx-auto flex px-6 py-28 md:h-[100vh] ${className}`}
    >
      <div className="grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-8">
          ...
          {/* CTA */}
          <CustomButton href={baseWhats + encodeURIComponent(t('home.excel.whatsappMsg'))} color='dark' icon="mdi:whatsapp" label={t('home.excel.cta')} />
        </div>
