...
const FrontendDevSection: React.FC<FrontendDevSectionProps> = ({ className = '' }) => {
  ...
  return (
    <section id='frontend' className={`w-full max-w-7xl mx-auto flex px-6 py-28 md:h-[100vh] ${className}`}>
      <div className="grid md:grid-cols-2 gap-14 items-center">
        ...
        <div className="space-y-6">
          ...
          {/* CTA */}
          <CustomButton href={baseWhats + encodeURIComponent(t('home.frontend.whatsappMsg'))} color='dark'  icon="mdi:whatsapp" label={t('home.frontend.cta')} />
